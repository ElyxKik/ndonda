...
class _AIChatScreenState extends State<AIChatScreen> {
  ...
  void _addWelcomeMessage() {
    setState(() {
      _messages.add(
        Message(
          text: 'Bonjour! 👋 Je suis votre assistant IA. Je suis ici pour vous aider avec vos questions sur ENVIROX, les rapports environnementaux, ou tout autre sujet. Comment puis-je vous aider?',
          isUser: false,
  ...
  void _resetChat() {
    showDialog(
      ...
      builder: (context) => AlertDialog(
        ...
        content: const Text('Êtes-vous sûr de vouloir effacer tout l\'historique du chat?'),
        actions: [
          TextButton(
            ...
            IconButton(
              ...
              onPressed: () {
                showDialog(
                  context: context,
                  builder: (context) =>
                      const ConversationHistoryModal(chatType: 'simple'),
                );
              },
